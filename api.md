...
- <code title="get /v1/accounts/{account_id}">client.accounts.<a href="./src/resources/accounts/accounts.ts">retrieve</a>(accountId, { ...params }) -> Account</code>
...
- <code title="get /v1/accounts">client.accounts.<a href="./src/resources/accounts/accounts.ts">list</a>({ ...params }) -> AccountPaged</code>
...
- <code title="get /v1/accounts/{account_id}/capability_requests">client.accounts.capabilityRequests.<a href="./src/resources/accounts/capability-requests.ts">list</a>(accountId, { ...params }) -> CapabilityRequestPaged</code>
...
- <code title="get /v1/linked_bank_accounts/{linked_bank_account_id}">client.linkedBankAccounts.<a href="./src/resources/linked-bank-accounts.ts">retrieve</a>(linkedBankAccountId, { ...params }) -> LinkedBankAccount</code>
...
- <code title="get /v1/linked_bank_accounts">client.linkedBankAccounts.<a href="./src/resources/linked-bank-accounts.ts">list</a>({ ...params }) -> LinkedBankAccountPaged</code>
...
- <code title="get /v1/organizations">client.organizations.<a href="./src/resources/organizations.ts">list</a>({ ...params }) -> OrganizationPaged</code>
...
- <code title="get /v1/representatives/{representative_id}">client.representatives.<a href="./src/resources/representatives.ts">retrieve</a>(representativeId, { ...params }) -> Representative</code>
...
- <code title="get /v1/representatives">client.representatives.<a href="./src/resources/representatives.ts">list</a>({ ...params }) -> RepresentativePaged</code>
...
- <code title="post /v1/bridge/plaid">client.bridge.<a href="./src/resources/bridge/bridge.ts">plaid</a>({ ...params }) -> Paykey</code>

## BankAccount

Methods:

- <code title="post /v1/bridge/bank_account">client.bridge.bankAccount.<a href="./src/resources/bridge/bank-account.ts">create</a>({ ...params }) -> Paykey</code>
...
- <code title="get /v1/customers/{id}">client.customers.<a href="./src/resources/customers/customers.ts">retrieve</a>(id, { ...params }) -> Customer</code>
...
- <code title="get /v1/customers">client.customers.<a href="./src/resources/customers/customers.ts">list</a>({ ...params }) -> CustomerSummaryPaged</code>
...
- <code title="get /v1/customers/{id}/review">client.customers.review.<a href="./src/resources/customers/review.ts">retrieve</a>(id, { ...params }) -> CustomerReview</code>
...
- <code title="get /v1/paykeys/{id}">client.paykeys.<a href="./src/resources/paykeys.ts">retrieve</a>(id, { ...params }) -> Paykey</code>
- <code title="get /v1/paykeys">client.paykeys.<a href="./src/resources/paykeys.ts">list</a>({ ...params }) -> PaykeySummaryPaged</code>
...
- <code title="get /v1/charges/{id}">client.charges.<a href="./src/resources/charges.ts">retrieve</a>(id, { ...params }) -> Charge</code>
...
- <code title="get /v1/funding_events/{id}">client.fundingEvents.<a href="./src/resources/funding-events.ts">retrieve</a>(id, { ...params }) -> FundingEventSummaryItem</code>
- <code title="get /v1/funding_events">client.fundingEvents.<a href="./src/resources/funding-events.ts">list</a>({ ...params }) -> FundingEventSummaryPaged</code>
...
- <code title="get /v1/payments">client.payments.<a href="./src/resources/payments.ts">list</a>({ ...params }) -> PaymentSummaryPaged</code>
...
- <code title="get /v1/payouts/{id}">client.payouts.<a href="./src/resources/payouts.ts">retrieve</a>(id, { ...params }) -> Payout</code>
