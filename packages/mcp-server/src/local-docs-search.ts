...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ data: { paykey_details: { id: string; config: object; created_at: string; label: string; paykey: string; source: 'bank_account' | 'straddle' | 'mx' | 'plaid' | 'tan' | 'quiltt' | 'mastercard'; status: 'pending' | 'active' | 'inactive' | 'rejected' | 'review' | 'blocked'; updated_at: string; balance?: object; bank_data?: object; customer_id?: string; expires_at?: string; external_id?: string; institution_name?: string; metadata?: object; status_details?: object; unblock_eligible?: boolean; }; verification_details?: { id: string; breakdown: object; created_at: string; decision: 'accept' | 'reject' | 'review'; messages: object; updated_at: string; }; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }",
    markdown:
  ...
  },
  {
    ...
    response:
      "{ data: { id: string; amount: number; config: object; consent_type: 'internet' | 'signed'; created_at: string; currency: string; description: string; device: device_info_v1; external_id: string; funding_ids: string[]; has_refund: boolean; has_resubmit: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: status_details_v1; status_history: object[]; trace_ids: object; updated_at: string; customer_details?: customer_details_v1; documents?: object[]; effective_at?: string; metadata?: object; paykey_details?: paykey_details_v1; payment_rail?: 'ach'; processed_at?: string; related_payments?: object[]; }; meta: object; response_type: 'object' | 'array' | 'error' | 'none'; }",
    markdown:
      "## get\n\n`client.charges.get(id: string, Correlation-Id?: string, Request-Id?: string, Straddle-Account-Id?: string): { data: object; meta: response_metadata; response_type: 'object' | 'array' | 'error' | 'none'; }`\n\n**get** `/v1/charges/{id}`\n\nRetrieves the details of an existing charge. Supply the unique charge `id`, and Straddle will return the corresponding charge information.\n\n### Parameters\n\n- `id: string`\n\n- `Correlation-Id?: string`\n\n- `Request-Id?: string`\n\n- `Straddle-Account-Id?: string`\n\n### Returns\n\n- `{ data: { id: string; amount: number; config: { balance_check: 'required' | 'enabled' | 'disabled'; auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; consent_type: 'internet' | 'signed'; created_at: string; currency: string; description: string; device: object; external_id: string; funding_ids: string[]; has_refund: boolean; has_resubmit: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: object; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; updated_at: string; customer_details?: object; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: object; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }`\n\n  - `data: { id: string; amount: number; config: { balance_check: 'required' | 'enabled' | 'disabled'; auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; consent_type: 'internet' | 'signed'; created_at: string; currency: string; description: string; device: { ip_address: string; }; external_id: string; funding_ids: string[]; has_refund: boolean; has_resubmit: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; code?: string; }; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; updated_at: string; customer_details?: { id: string; customer_type: 'individual' | 'business'; email: string; name: string; phone: string; }; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: { id: string; customer_id: string; label: string; balance?: number; }; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; }`\n  - `meta: { api_request_id: string; api_request_timestamp: string; }`\n  - `response_type: 'object' | 'array' | 'error' | 'none'`\n\n### Example\n\n```typescript\nimport Straddle from '@straddlecom/straddle';\n\nconst client = new Straddle();\n\nconst chargeV1 = await client.charges.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(chargeV1);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ data: { id: string; amount: number; config: object; consent_type: 'internet' | 'signed'; created_at: string; currency: string; description: string; device: object; external_id: string; funding_ids: string[]; has_refund: boolean; has_resubmit: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: status_details_v1; status_history: object[]; trace_ids: object; updated_at: string; customer_details?: customer_details_v1; documents?: object[]; effective_at?: string; metadata?: object; paykey_details?: paykey_details_v1; payment_rail?: 'ach'; processed_at?: string; related_payments?: object[]; }; meta: object; response_type: 'object' | 'array' | 'error' | 'none'; }",
    markdown:
      "## unmask\n\n`client.charges.unmask(id: string, Correlation-Id?: string, Request-Id?: string, Straddle-Account-Id?: string): { data: object; meta: response_metadata; response_type: 'object' | 'array' | 'error' | 'none'; }`\n\n**get** `/v1/charges/{id}/unmask`\n\nGet a charge by id.\n\n### Parameters\n\n- `id: string`\n\n- `Correlation-Id?: string`\n\n- `Request-Id?: string`\n\n- `Straddle-Account-Id?: string`\n\n### Returns\n\n- `{ data: { id: string; amount: number; config: { balance_check: 'required' | 'enabled' | 'disabled'; auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; consent_type: 'internet' | 'signed'; created_at: string; currency: string; description: string; device: { ip_address: string; }; external_id: string; funding_ids: string[]; has_refund: boolean; has_resubmit: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: object; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; updated_at: string; customer_details?: object; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: object; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }`\n\n  - `data: { id: string; amount: number; config: { balance_check: 'required' | 'enabled' | 'disabled'; auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; consent_type: 'internet' | 'signed'; created_at: string; currency: string; description: string; device: { ip_address: string; }; external_id: string; funding_ids: string[]; has_refund: boolean; has_resubmit: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; code?: string; }; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; updated_at: string; customer_details?: { id: string; customer_type: 'individual' | 'business'; email: string; name: string; phone: string; }; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: { id: string; customer_id: string; label: string; balance?: number; }; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; }`\n  - `meta: { api_request_id: string; api_request_timestamp: string; }`\n  - `response_type: 'object' | 'array' | 'error' | 'none'`\n\n### Example\n\n```typescript\nimport Straddle from '@straddlecom/straddle';\n\nconst client = new Straddle();\n\nconst response = await client.charges.unmask('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ data: { id: string; amount: number; config: { auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; currency: string; description: string; device: object; external_id: string; funding_ids: string[]; has_resubmit: boolean; is_refund: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: object; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; created_at?: string; customer_details?: object; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: object; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; updated_at?: string; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }",
    markdown:
      "## get\n\n`client.payouts.get(id: string, Correlation-Id?: string, Request-Id?: string, Straddle-Account-Id?: string): { data: object; meta: response_metadata; response_type: 'object' | 'array' | 'error' | 'none'; }`\n\n**get** `/v1/payouts/{id}`\n\nRetrieves the details of an existing payout. Supply the unique payout `id` to retrieve the corresponding payout information.\n\n### Parameters\n\n- `id: string`\n\n- `Correlation-Id?: string`\n\n- `Request-Id?: string`\n\n- `Straddle-Account-Id?: string`\n\n### Returns\n\n- `{ data: { id: string; amount: number; config: { auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; currency: string; description: string; device: object; external_id: string; funding_ids: string[]; has_resubmit: boolean; is_refund: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: object; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; created_at?: string; customer_details?: object; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: object; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; updated_at?: string; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }`\n\n  - `data: { id: string; amount: number; config: { auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; currency: string; description: string; device: { ip_address: string; }; external_id: string; funding_ids: string[]; has_resubmit: boolean; is_refund: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; code?: string; }; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; created_at?: string; customer_details?: { id: string; customer_type: 'individual' | 'business'; email: string; name: string; phone: string; }; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: { id: string; customer_id: string; label: string; balance?: number; }; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; updated_at?: string; }`\n  - `meta: { api_request_id: string; api_request_timestamp: string; }`\n  - `response_type: 'object' | 'array' | 'error' | 'none'`\n\n### Example\n\n```typescript\nimport Straddle from '@straddlecom/straddle';\n\nconst client = new Straddle();\n\nconst payoutV1 = await client.payouts.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');\n\nconsole.log(payoutV1);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'upload_authorization_document',
    endpoint: '/v1/payouts/{id}/authorization',
    httpMethod: 'post',
    summary: 'Upload a proof-of-authorization document for a payout.',
    description:
      'Uploads a document as proof of authorization for a payout. Uploading again adds another entry to documents rather than replacing the previous one.',
    stainlessPath: '(resource) payouts > (method) upload_authorization_document',
    qualified: 'client.payouts.uploadAuthorizationDocument',
    params: [
      'id: string;',
      'File: string;',
      'Correlation-Id?: string;',
    ...
    response:
      "{ data: { id: string; amount: number; config: { auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; currency: string; description: string; device: object; external_id: string; funding_ids: string[]; has_resubmit: boolean; is_refund: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: object; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; created_at?: string; customer_details?: object; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: object; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; updated_at?: string; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }",
    markdown:
      "## upload_authorization_document\n\n`client.payouts.uploadAuthorizationDocument(id: string, File: string, Correlation-Id?: string, Idempotency-Key?: string, Request-Id?: string, Straddle-Account-Id?: string): { data: object; meta: response_metadata; response_type: 'object' | 'array' | 'error' | 'none'; }`\n\n**post** `/v1/payouts/{id}/authorization`\n\nUploads a document as proof of authorization for a payout. Uploading again adds another entry to documents rather than replacing the previous one.\n\n### Parameters\n\n- `id: string`\n\n- `File: string`\n  The document file to upload as proof of authorization for this payout.\n\n- `Correlation-Id?: string`\n\n- `Idempotency-Key?: string`\n\n- `Request-Id?: string`\n\n- `Straddle-Account-Id?: string`\n\n### Returns\n\n- `{ data: { id: string; amount: number; config: { auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; currency: string; description: string; device: object; external_id: string; funding_ids: string[]; has_resubmit: boolean; is_refund: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: object; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; created_at?: string; customer_details?: object; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: object; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; updated_at?: string; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }`\n\n  - `data: { id: string; amount: number; config: { auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; currency: string; description: string; device: { ip_address: string; }; external_id: string; funding_ids: string[]; has_resubmit: boolean; is_refund: boolean; is_resubmit: boolean; paykey: string; payment_date: string; status: string; status_details: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; code?: string; }; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; created_at?: string; customer_details?: { id: string; customer_type: 'individual' | 'business'; email: string; name: string; phone: string; }; documents?: { document_id: string; document_name: string; document_size: number; document_type: 'payment_authorization'; uploaded_at: string; }[]; effective_at?: string; metadata?: object; paykey_details?: { id: string; customer_id: string; label: string; balance?: number; }; payment_rail?: 'ach'; processed_at?: string; related_payments?: { id: string; payment_type: 'charge' | 'payout'; relationship: 'original' | 'resubmit' | 'refund'; }[]; updated_at?: string; }`\n  - `meta: { api_request_id: string; api_request_timestamp: string; }`\n  - `response_type: 'object' | 'array' | 'error' | 'none'`\n\n### Example\n\n```typescript\nimport Straddle from '@straddlecom/straddle';\n\nconst client = new Straddle();\n\nconst payoutV1 = await client.payouts.uploadAuthorizationDocument('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { File: fs.createReadStream('path/to/file') });\n\nconsole.log(payoutV1);\n```",
    perLanguage: {
      typescript: {
        method: 'client.payouts.uploadAuthorizationDocument',
        example:
          "import fs from 'fs';\nimport Straddle from '@straddlecom/straddle';\n\nconst client = new Straddle({\n  apiKey: process.env['STRADDLE_API_KEY'], // This is the default and can be omitted\n});\n\nconst payoutV1 = await client.payouts.uploadAuthorizationDocument(\n  '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',\n  { File: fs.createReadStream('path/to/file') },\n);\n\nconsole.log(payoutV1.data);",
      },
      python: {
        method: 'payouts.upload_authorization_document',
        example:
          'import os\nfrom straddle import Straddle\n\nclient = Straddle(\n    api_key=os.environ.get("STRADDLE_API_KEY"),  # This is the default and can be omitted\n)\npayout_v1 = client.payouts.upload_authorization_document(\n    id="182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n    file=b"Example data",\n)\nprint(payout_v1.data)',
      },
      go: {
        method: 'client.Payouts.UploadAuthorizationDocument',
        example:
          'package main\n\nimport (\n\t"bytes"\n\t"context"\n\t"fmt"\n\t"io"\n\n\t"github.com/straddleio/straddle-go"\n\t"github.com/straddleio/straddle-go/option"\n)\n\nfunc main() {\n\tclient := straddle.NewClient(\n\t\toption.WithAPIKey("My API Key"),\n\t)\n\tpayoutV1, err := client.Payouts.UploadAuthorizationDocument(\n\t\tcontext.TODO(),\n\t\t"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n\t\tstraddle.PayoutUploadAuthorizationDocumentParams{\n\t\t\tFile: io.Reader(bytes.NewBuffer([]byte("Example data"))),\n\t\t},\n\t)\n\tif err != nil {\n\t\tpanic(err.Error())\n\t}\n\tfmt.Printf("%+v\\n", payoutV1.Data)\n}\n',
      },
      ruby: {
        method: 'payouts.upload_authorization_document',
        example:
          'require "straddle"\n\nstraddle = Straddle::Client.new(\n  api_key: "My API Key",\n  environment: "production" # defaults to "sandbox"\n)\n\npayout_v1 = straddle.payouts.upload_authorization_document(\n  "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n  file: StringIO.new("Example data")\n)\n\nputs(payout_v1)',
      },
      cli: {
        method: 'payouts upload_authorization_document',
        example:
          "straddle payouts upload-authorization-document \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --file 'Example data'",
      },
      csharp: {
        method: 'Payouts.UploadAuthorizationDocument',
        example:
          'PayoutUploadAuthorizationDocumentParams parameters = new()\n{\n    ID = "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",\n    File = Encoding.UTF8.GetBytes("Example data"),\n};\n\nvar payoutV1 = await client.Payouts.UploadAuthorizationDocument(parameters);\n\nConsole.WriteLine(payoutV1);',
      },
      http: {
        example:
          "curl https://sandbox.straddle.com/v1/payouts/$ID/authorization \\\n    -H 'Content-Type: multipart/form-data' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -F 'File=@/path/to/File'",
      },
    },
  },
  {
