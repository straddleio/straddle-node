...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "description": "Retrieves the details of an account that has previously been created. Supply the unique account ID that was returned from your previous request, and Straddle will return the corresponding account information.",
  ...
  },
  {
    ...
    "description": "Updates an existing account's information. This endpoint allows you to update various account details during onboarding or after the account has been created.",
  ...
  },
  {
    ...
    "description": "Creates a new account associated with your Straddle platform integration. This endpoint allows you to set up an account with specified details, including business information and access levels.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle embed:accounts create \\\n  --api-key 'My API Key' \\\n  --access-level standard \\\n  --account-type business \\\n  --business-profile '{name: name, website: https://example.com}' \\\n  --organization-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Embed.Accounts.Create",
        "example": "AccountCreateParams parameters = new()\n{\n    AccessLevel = AccessLevel.Standard,\n    AccountType = AccountType.Business,\n    BusinessProfile = new()\n    {\n        Name = \"name\",\n        Website = \"https://example.com\",\n        Address = new()\n        {\n            Address1 = \"address1\",\n            City = \"city\",\n            Line1 = \"line1\",\n            PostalCode = \"21029-1360\",\n            State = \"SE\",\n            Zip = \"zip\",\n            Address2 = \"address2\",\n            Country = \"country\",\n            Line2 = \"line2\",\n        },\n        Description = \"description\",\n        Industry = new()\n        {\n            Category = \"category\",\n            Mcc = \"mcc\",\n            Sector = \"sector\",\n        },\n        LegalName = \"legal_name\",\n        Phone = \"+46991022\",\n        SupportChannels = new()\n        {\n            Email = \"dev@stainless.com\",\n            Phone = \"+46991022\",\n            Url = \"https://example.com\",\n        },\n        TaxID = \"210297980\",\n        UseCase = \"use_case\",\n    },\n    OrganizationID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n};\n\nvar accountV1 = await client.Embed.Accounts.Create(parameters);\n\nConsole.WriteLine(accountV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/accounts \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"access_level\": \"standard\",\n          \"account_type\": \"business\",\n          \"business_profile\": {\n            \"name\": \"name\",\n            \"website\": \"https://example.com\"\n          },\n          \"organization_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Returns a list of accounts associated with your Straddle platform integration. The accounts are returned sorted by creation date, with the most recently created accounts appearing first. This endpoint supports advanced sorting and filtering options.",
  ...
  },
  {
    ...
    "description": "Initiates the onboarding process for a new account. This endpoint can only be used for accounts where at least one representative and one bank account have already been created.",
  ...
  },
  {
    ...
    "description": "Simulate the status transitions for sandbox accounts. This endpoint can only be used for sandbox accounts.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle embed:accounts simulate \\\n  --api-key 'My API Key' \\\n  --account-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Embed.Accounts.Simulate",
        "example": "AccountSimulateParams parameters = new()\n{\n    AccountID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar accountV1 = await client.Embed.Accounts.Simulate(parameters);\n\nConsole.WriteLine(accountV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/accounts/$ACCOUNT_ID/simulate \\\n    -X POST \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Submits a request to enable a specific capability for an account. Use this endpoint to request additional features or services for an account.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle embed:accounts:capability-requests create \\\n  --api-key 'My API Key' \\\n  --account-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Embed.Accounts.CapabilityRequests.Create",
        "example": "CapabilityRequestCreateParams parameters = new()\n{\n    AccountID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar capabilityRequestPagedV1 = await client.Embed.Accounts.CapabilityRequests.Create(parameters);\n\nConsole.WriteLine(capabilityRequestPagedV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/accounts/$ACCOUNT_ID/capability_requests \\\n    -X POST \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves a list of capability requests associated with an account. The requests are returned sorted by creation date, with the most recent requests appearing first. This endpoint supports advanced sorting and filtering options.",
    ...
    "response": "{ id: string; account_id: string; category: 'payment_type' | 'customer_type' | 'consent_type'; created_at: string; enable: boolean; status: 'active' | 'inactive' | 'in_review' | 'rejected' | 'approved' | 'reviewing'; type: 'charges' | 'payouts' | 'individuals' | 'businesses' | 'signed_agreement' | 'internet'; updated_at: string; settings?: object; }",
  ...
  },
  {
    ...
    "description": "Creates a new linked bank account associated with a Straddle account. This endpoint allows you to associate external bank accounts with a Straddle account for various payment operations such as payment deposits, payout withdrawals, and more.",
  ...
  },
  {
    ...
    "description": "Returns a list of bank accounts associated with a specific Straddle account. The linked bank accounts are returned sorted by creation date, with the most recently created appearing first. This endpoint supports pagination to handle accounts with multiple linked bank accounts.",
    ...
    "response": "{ id: string; account_id: string; bank_account: { account_holder: string; account_mask: string; institution_name: string; routing_number: string; }; created_at: string; purposes: 'charges' | 'payouts' | 'billing'[]; status: 'created' | 'onboarding' | 'active' | 'rejected' | 'inactive' | 'canceled'; status_detail: { code: string; message: string; reason: string; source: 'watchtower'; }; updated_at: string; description?: string; metadata?: object; platform_id?: string; }",
  ...
  },
  {
    ...
    "description": "Updates an existing linked bank account's information. This can be used to update account details during onboarding or to update metadata associated with the linked account. The linked bank account must be in 'created' or 'onboarding' status.",
  ...
  },
  {
    ...
    "description": "Retrieves the details of a linked bank account that has previously been created. Supply the unique linked bank account `id`, and Straddle will return the corresponding information. The response includes masked account details for security purposes.",
  ...
  },
  {
    ...
    "response": "{ data: { id: string; account_id: string; bank_account: { account_holder: string; account_number: string; institution_name: string; routing_number: string; }; created_at: string; status: 'created' | 'onboarding' | 'active' | 'rejected' | 'inactive' | 'canceled'; status_detail: { code: string; message: string; reason: string; source: 'watchtower'; }; updated_at: string; metadata?: object; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle embed:linked-bank-accounts unmask \\\n  --api-key 'My API Key' \\\n  --linked-bank-account-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Embed.LinkedBankAccounts.Unmask",
        "example": "LinkedBankAccountUnmaskParams parameters = new()\n{\n    LinkedBankAccountID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar linkedBankAccountUnmaskV1 = await client.Embed.LinkedBankAccounts.Unmask(parameters);\n\nConsole.WriteLine(linkedBankAccountUnmaskV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/linked_bank_accounts/$LINKED_BANK_ACCOUNT_ID/unmask \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Cancels an existing linked bank account. This can be used to cancel a linked bank account before it has been reviewed. The linked bank account must be in 'created' status.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle embed:linked-bank-accounts cancel \\\n  --api-key 'My API Key' \\\n  --linked-bank-account-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Embed.LinkedBankAccounts.Cancel",
        "example": "LinkedBankAccountCancelParams parameters = new()\n{\n    LinkedBankAccountID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar linkedBankAccountV1 = await client.Embed.LinkedBankAccounts.Cancel(parameters);\n\nConsole.WriteLine(linkedBankAccountV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/linked_bank_accounts/$LINKED_BANK_ACCOUNT_ID/cancel \\\n    -X PATCH \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new organization related to your Straddle integration. Organizations can be used to group related accounts and manage permissions across multiple users.",
    ...
    "response": "{ data: { id: string; created_at: string; name: string; updated_at: string; external_id?: string; metadata?: object; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }",
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Embed.Organizations.Create",
        "example": "OrganizationCreateParams parameters = new() { Name = \"name\" };\n\nvar organizationV1 = await client.Embed.Organizations.Create(parameters);\n\nConsole.WriteLine(organizationV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/organizations \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"name\": \"name\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; created_at: string; name: string; updated_at: string; external_id?: string; metadata?: object; }",
  ...
  },
  {
    ...
    "description": "Retrieves the details of an Organization that has previously been created. Supply the unique organization ID that was returned from your previous request, and Straddle will return the corresponding organization information.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle embed:organizations get \\\n  --api-key 'My API Key' \\\n  --organization-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Embed.Organizations.Get",
        "example": "OrganizationGetParams parameters = new()\n{\n    OrganizationID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar organizationV1 = await client.Embed.Organizations.Get(parameters);\n\nConsole.WriteLine(organizationV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/organizations/$ORGANIZATION_ID \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new representative associated with an account. Representatives are individuals who have legal authority or significant responsibility within the business.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle embed:representatives create \\\n  --api-key 'My API Key' \\\n  --account-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --dob \"'1980-01-01'\" \\\n  --email ron.swanson@pawnee.com \\\n  --first-name first_name \\\n  --last-name last_name \\\n  --mobile-number +12128675309 \\\n  --relationship '{control: true, owner: true, primary: true}' \\\n  --ssn-last4 1234"
      },
      "csharp": {
        "method": "Embed.Representatives.Create",
        "example": "RepresentativeCreateParams parameters = new()\n{\n    AccountID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    Dob = \"1980-01-01\",\n    Email = \"ron.swanson@pawnee.com\",\n    FirstName = \"first_name\",\n    LastName = \"last_name\",\n    MobileNumber = \"+12128675309\",\n    Relationship = new()\n    {\n        Control = true,\n        Owner = true,\n        Primary = true,\n        PercentOwnership = 0,\n        Title = \"title\",\n    },\n    SsnLast4 = \"1234\",\n};\n\nvar representative = await client.Embed.Representatives.Create(parameters);\n\nConsole.WriteLine(representative);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/representatives \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"account_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"dob\": \"1980-01-01\",\n          \"email\": \"ron.swanson@pawnee.com\",\n          \"first_name\": \"first_name\",\n          \"last_name\": \"last_name\",\n          \"mobile_number\": \"+12128675309\",\n          \"relationship\": {\n            \"control\": true,\n            \"owner\": true,\n            \"primary\": true\n          },\n          \"ssn_last4\": \"1234\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Returns a list of representatives associated with a specific account or organization. The representatives are returned sorted by creation date, with the most recently created representatives appearing first. This endpoint supports advanced sorting and filtering options.",
    ...
    "response": "{ id: string; account_id: string; created_at: string; dob: string; email: string; first_name: string; last_name: string; mobile_number: string; name: string; relationship: { control: boolean; owner: boolean; primary: boolean; percent_ownership?: number; title?: string; }; ssn_last4: string; status: 'created' | 'onboarding' | 'active' | 'rejected' | 'inactive'; status_detail: { code: string; message: string; reason: string; source: 'watchtower'; }; updated_at: string; external_id?: string; metadata?: object; phone?: string; user_id?: string; }",
  ...
  },
  {
    ...
    "description": "Updates an existing representative's information. This can be used to update personal details, contact information, or the relationship to the account or organization.",
  ...
  },
  {
    ...
    "description": "Retrieves the details of an existing representative. Supply the unique representative ID, and Straddle will return the corresponding representative information.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle embed:representatives get \\\n  --api-key 'My API Key' \\\n  --representative-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Embed.Representatives.Get",
        "example": "RepresentativeGetParams parameters = new()\n{\n    RepresentativeID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar representative = await client.Embed.Representatives.Get(parameters);\n\nConsole.WriteLine(representative);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/representatives/$REPRESENTATIVE_ID \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
  ...
  },
  {
    ...
    "description": "Retrieves the unmasked details of a representative that has previously been created. Supply the unique representative ID, and Straddle will return the corresponding representative information, including sensitive details. This endpoint requires additional authentication and should be used with caution.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle embed:representatives unmask \\\n  --api-key 'My API Key' \\\n  --representative-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Embed.Representatives.Unmask",
        "example": "RepresentativeUnmaskParams parameters = new()\n{\n    RepresentativeID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar representative = await client.Embed.Representatives.Unmask(parameters);\n\nConsole.WriteLine(representative);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/representatives/$REPRESENTATIVE_ID/unmask \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { bridge_token: string; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "bridge initialize",
        "example": "straddle bridge initialize \\\n  --api-key 'My API Key' \\\n  --customer-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Bridge.Initialize",
        "example": "BridgeInitializeParams parameters = new()\n{\n    CustomerID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar bridgeTokenV1 = await client.Bridge.Initialize(parameters);\n\nConsole.WriteLine(bridgeTokenV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/bridge/initialize \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"customer_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Use Bridge to create a new paykey using a bank routing and account number as the source. This endpoint allows you to create a secure payment token linked to a specific bank account.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle bridge:link bank-account \\\n  --api-key 'My API Key' \\\n  --account-number account_number \\\n  --account-type checking \\\n  --customer-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --routing-number xxxxxxxxx"
      },
      "csharp": {
        "method": "Bridge.Link.BankAccount",
        "example": "LinkBankAccountParams parameters = new()\n{\n    AccountNumber = \"account_number\",\n    AccountType = AccountType.Checking,\n    CustomerID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    RoutingNumber = \"xxxxxxxxx\",\n};\n\nvar paykeyV1 = await client.Bridge.Link.BankAccount(parameters);\n\nConsole.WriteLine(paykeyV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/bridge/bank_account \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"account_number\": \"account_number\",\n          \"account_type\": \"checking\",\n          \"customer_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"routing_number\": \"xxxxxxxxx\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Use Bridge to create a new paykey using a Plaid token as the source. This endpoint allows you to create a secure payment token linked to a bank account authenticated through Plaid.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "link plaid",
        "example": "straddle bridge:link plaid \\\n  --api-key 'My API Key' \\\n  --customer-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --plaid-token plaid_token"
      },
      "csharp": {
        "method": "Bridge.Link.Plaid",
        "example": "LinkPlaidParams parameters = new()\n{\n    CustomerID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    PlaidToken = \"plaid_token\",\n};\n\nvar paykeyV1 = await client.Bridge.Link.Plaid(parameters);\n\nConsole.WriteLine(paykeyV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/bridge/plaid \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"customer_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"plaid_token\": \"plaid_token\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle bridge:link create-tan \\\n  --api-key 'My API Key' \\\n  --account-type checking \\\n  --customer-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --routing-number routing_number \\\n  --tan tan"
      },
      "csharp": {
        "method": "Bridge.Link.CreateTan",
        "example": "LinkCreateTanParams parameters = new()\n{\n    AccountType = AccountType.Checking,\n    CustomerID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    RoutingNumber = \"routing_number\",\n    Tan = \"tan\",\n};\n\nvar response = await client.Bridge.Link.CreateTan(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/bridge/tan \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"account_type\": \"checking\",\n          \"customer_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"routing_number\": \"routing_number\",\n          \"tan\": \"tan\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Creates a new paykey using a Quiltt token as the source. This endpoint allows you to create a secure payment token linked to a bank account authenticated through Quiltt.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle bridge:link create-paykey \\\n  --api-key 'My API Key' \\\n  --customer-id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --quiltt-token quiltt_token"
      },
      "csharp": {
        "method": "Bridge.Link.CreatePaykey",
        "example": "LinkCreatePaykeyParams parameters = new()\n{\n    CustomerID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    QuilttToken = \"quiltt_token\",\n};\n\nvar response = await client.Bridge.Link.CreatePaykey(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/bridge/quiltt \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"customer_id\": \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n          \"quiltt_token\": \"quiltt_token\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Retrieves the details of an existing customer. Supply the unique customer ID that was returned from your 'create customer' request, and Straddle will return the corresponding customer information.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "customers get",
        "example": "straddle customers get \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Customers.Get",
        "example": "CustomerGetParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar customerV1 = await client.Customers.Get(parameters);\n\nConsole.WriteLine(customerV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/customers/$ID \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Updates an existing customer's information. This endpoint allows you to modify the customer's contact details, PII, and metadata.",
  ...
  },
  {
    ...
    "description": "Permanently removes a customer record from Straddle. This action cannot be undone and should only be used to satisfy regulatory requirements or for privacy compliance.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "customers delete",
        "example": "straddle customers delete \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Customers.Delete",
        "example": "CustomerDeleteParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar customerV1 = await client.Customers.Delete(parameters);\n\nConsole.WriteLine(customerV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/customers/$ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
  ...
  },
  {
    ...
    "description": "Lists or searches customers connected to your account. All supported query parameters are optional. If none are provided, the response will include all customers connected to your account. This endpoint supports advanced sorting and filtering options.",
    ...
    "response": "{ id: string; created_at: string; email: string; name: string; phone: string; status: 'pending' | 'review' | 'verified' | 'inactive' | 'rejected'; type: 'individual' | 'business'; updated_at: string; external_id?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/customers \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Creates a new customer record and automatically initiates identity, fraud, and risk assessment scores. This endpoint allows you to create a customer profile and associate it with paykeys and payments.",
  ...
  },
  {
    ...
    "description": "Retrieves the unmasked details, including PII, of an existing customer. Supply the unique customer ID that was returned from your 'create customer' request, and Straddle will return the corresponding customer information. This endpoint needs to be enabled by Straddle and should only be used when absolutely necessary.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "customers unmasked",
        "example": "straddle customers unmasked \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Customers.Unmasked",
        "example": "CustomerUnmaskedParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar customerUnmaskedV1 = await client.Customers.Unmasked(parameters);\n\nConsole.WriteLine(customerUnmaskedV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/customers/$ID/unmasked \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "review get",
        "example": "straddle customers:review get \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Customers.Review.Get",
        "example": "ReviewGetParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar customerReviewV1 = await client.Customers.Review.Get(parameters);\n\nConsole.WriteLine(customerReviewV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/customers/$ID/review \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Updates the status of a customer's identity decision. This endpoint allows you to modify the outcome of a customer risk screening and is useful for correcting or updating the status of a customer's verification. Note that this endpoint is only available for customers with a current status of `review`.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle customers:review decision \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --status verified"
      },
      "csharp": {
        "method": "Customers.Review.Decision",
        "example": "ReviewDecisionParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    Status = Status.Verified,\n};\n\nvar customerV1 = await client.Customers.Review.Decision(parameters);\n\nConsole.WriteLine(customerV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/customers/$ID/review \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"status\": \"verified\"\n        }'"
      }
  ...
  },
  {
    ...
    "description": "Updates the decision of a customer's identity validation. This endpoint allows you to modify the outcome of a customer decision and is useful for correcting or updating the status of a customer's verification.",
    ...
    "perLanguage": {
      ...
      "cli": {
        ...
        "example": "straddle customers:review refresh-review \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Customers.Review.RefreshReview",
        "example": "ReviewRefreshReviewParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar customerV1 = await client.Customers.Review.RefreshReview(parameters);\n\nConsole.WriteLine(customerV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/customers/$ID/refresh_review \\\n    -X PUT \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves the details of an existing paykey. Supply the unique paykey `id` and Straddle will return the corresponding paykey record , including the `paykey` token value and masked bank account details.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "paykeys get",
        "example": "straddle paykeys get \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Paykeys.Get",
        "example": "PaykeyGetParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar paykeyV1 = await client.Paykeys.Get(parameters);\n\nConsole.WriteLine(paykeyV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/paykeys/$ID \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves the unmasked details of an existing paykey. Supply the unique paykey `id` and Straddle will return the corresponding paykey record, including the unmasked bank account details. This endpoint needs to be enabled by Straddle for your account and should only be used when absolutely necessary.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "paykeys unmasked",
        "example": "straddle paykeys unmasked \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Paykeys.Unmasked",
        "example": "PaykeyUnmaskedParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar paykeyUnmaskedV1 = await client.Paykeys.Unmasked(parameters);\n\nConsole.WriteLine(paykeyUnmaskedV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/paykeys/$ID/unmasked \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Returns a list of paykeys associated with a Straddle account. This endpoint supports advanced sorting and filtering options.",
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Paykeys.List",
        "example": "PaykeyListParams parameters = new();\n\nvar page = await client.Paykeys.List(parameters);\nawait foreach (var item in page.Paginate())\n{\n    Console.WriteLine(item);\n}"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/paykeys \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves the details of a paykey that has previously been created. Supply the unique paykey ID that was returned from your previous request, and Straddle will return the corresponding paykey information including the unmasked token.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "paykeys reveal",
        "example": "straddle paykeys reveal \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Paykeys.Reveal",
        "example": "PaykeyRevealParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar response = await client.Paykeys.Reveal(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/paykeys/$ID/reveal \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "paykeys cancel",
        "example": "straddle paykeys cancel \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Paykeys.Cancel",
        "example": "PaykeyCancelParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar paykeyV1 = await client.Paykeys.Cancel(parameters);\n\nConsole.WriteLine(paykeyV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/paykeys/$ID/cancel \\\n    -X PUT \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Updates the balance of a paykey. This endpoint allows you to refresh the balance of a paykey.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "paykeys update_balance",
        "example": "straddle paykeys update-balance \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Paykeys.UpdateBalance",
        "example": "PaykeyUpdateBalanceParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar paykeyV1 = await client.Paykeys.UpdateBalance(parameters);\n\nConsole.WriteLine(paykeyV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/paykeys/$ID/refresh_balance \\\n    -X PUT \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "review decision",
        "example": "straddle paykeys:review decision \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --status active"
      },
      "csharp": {
        "method": "Paykeys.Review.Decision",
      ...
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/paykeys/$ID/review \\\n    -X PATCH \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"status\": \"active\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ data: { paykey_details: { id: string; config: object; created_at: string; label: string; paykey: string; source: 'bank_account' | 'straddle' | 'mx' | 'plaid' | 'tan' | 'quiltt'; status: 'pending' | 'active' | 'inactive' | 'rejected' | 'review' | 'blocked'; updated_at: string; balance?: object; bank_data?: object; customer_id?: string; expires_at?: string; external_id?: string; institution_name?: string; metadata?: object; status_details?: object; unblock_eligible?: boolean; }; verification_details?: { id: string; breakdown: object; created_at: string; decision: 'accept' | 'reject' | 'review'; messages: object; updated_at: string; }; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "review get",
        "example": "straddle paykeys:review get \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Paykeys.Review.Get",
  ...
  },
  {
    ...
    "description": "Updates the decision of a paykey's review validation. This endpoint allows you to refresh the outcome of a paykey's decision and is useful for correcting or updating the status of a paykey's verification.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "review refresh_review",
        "example": "straddle paykeys:review refresh-review \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
      ...
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/paykeys/$ID/refresh_review \\\n    -X PUT \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves the details of an existing charge. Supply the unique charge `id`, and Straddle will return the corresponding charge information.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "charges get",
        "example": "straddle charges get \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Charges.Get",
        "example": "ChargeGetParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar chargeV1 = await client.Charges.Get(parameters);\n\nConsole.WriteLine(chargeV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/charges/$ID \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Change the values of parameters associated with a charge prior to processing. The status of the charge must be `created`, `scheduled`, or `on_hold`.",
  ...
  },
  {
    ...
    "description": "Place a charge on hold to prevent it from being originated for processing. The status of the charge must be `created` or `scheduled`.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "charges hold",
        "example": "straddle charges hold \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Charges.Hold",
        "example": "ChargeHoldParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar chargeV1 = await client.Charges.Hold(parameters);\n\nConsole.WriteLine(chargeV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/charges/$ID/hold \\\n    -X PUT \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "charges release",
        "example": "straddle charges release \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Charges.Release",
        "example": "ChargeReleaseParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar chargeV1 = await client.Charges.Release(parameters);\n\nConsole.WriteLine(chargeV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/charges/$ID/release \\\n    -X PUT \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Cancel a charge to prevent it from being originated for processing. The status of the charge must be `created`, `scheduled`, or `on_hold`.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "charges cancel",
        "example": "straddle charges cancel \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Charges.Cancel",
        "example": "ChargeCancelParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar chargeV1 = await client.Charges.Cancel(parameters);\n\nConsole.WriteLine(chargeV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/charges/$ID/cancel \\\n    -X PUT \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "charges unmask",
        "example": "straddle charges unmask \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Charges.Unmask",
        "example": "ChargeUnmaskParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar response = await client.Charges.Unmask(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/charges/$ID/unmask \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves a list of funding events for your account. This endpoint supports advanced sorting and filtering options.",
    ...
    "perLanguage": {
      ...
      "csharp": {
        ...
        "example": "FundingEventListParams parameters = new();\n\nvar page = await client.FundingEvents.List(parameters);\nawait foreach (var item in page.Paginate())\n{\n    Console.WriteLine(item);\n}"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/funding_events \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves the details of an existing funding event. Supply the unique funding event `id`, and Straddle will return the individual transaction items that make up the funding event.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "funding_events get",
        "example": "straddle funding-events get \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "FundingEvents.Get",
        "example": "FundingEventGetParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar fundingEventSummaryItemV1 = await client.FundingEvents.Get(parameters);\n\nConsole.WriteLine(fundingEventSummaryItemV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/funding_events/$ID \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Search for payments, including `charges` and `payouts`, using a variety of criteria. This endpoint supports advanced sorting and filtering options.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/payments \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Retrieves the details of an existing payout. Supply the unique payout `id` to retrieve the corresponding payout information.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "payouts get",
        "example": "straddle payouts get \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Payouts.Get",
        "example": "PayoutGetParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar payoutV1 = await client.Payouts.Get(parameters);\n\nConsole.WriteLine(payoutV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/payouts/$ID \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "description": "Update the details of a payout prior to processing. The status of the payout must be `created`, `scheduled`, or `on_hold`.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "payouts update",
        "example": "straddle payouts update \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --amount 10000 \\\n  --description description \\\n  --payment-date \"'2019-12-27'\""
      },
      "csharp": {
        "method": "Payouts.Update",
        "example": "PayoutUpdateParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    Amount = 10000,\n    Description = \"description\",\n    PaymentDate = \"2019-12-27\",\n};\n\nvar payoutV1 = await client.Payouts.Update(parameters);\n\nConsole.WriteLine(payoutV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/payouts/$ID \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"amount\": 10000,\n          \"description\": \"description\",\n          \"payment_date\": \"2019-12-27\"\n        }'"
      }
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        "method": "Payouts.Create",
        "example": "PayoutCreateParams parameters = new()\n{\n    Amount = 10000,\n    Currency = \"currency\",\n    Description = \"Vendor invoice payment\",\n    Device = new(\"192.168.1.1\"),\n    ExternalID = \"external_id\",\n    Paykey = \"paykey\",\n    PaymentDate = \"2019-12-27\",\n};\n\nvar payoutV1 = await client.Payouts.Create(parameters);\n\nConsole.WriteLine(payoutV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/payouts \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"amount\": 10000,\n          \"currency\": \"currency\",\n          \"description\": \"Vendor invoice payment\",\n          \"device\": {\n            \"ip_address\": \"192.168.1.1\"\n          },\n          \"external_id\": \"external_id\",\n          \"paykey\": \"paykey\",\n          \"payment_date\": \"2019-12-27\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Hold a payout to prevent it from being processed. The status of the payout must be `created`, `scheduled`, or `on_hold`.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "payouts hold",
        "example": "straddle payouts hold \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --reason reason"
      },
      "csharp": {
        "method": "Payouts.Hold",
        "example": "PayoutHoldParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    Reason = \"reason\",\n};\n\nvar payoutV1 = await client.Payouts.Hold(parameters);\n\nConsole.WriteLine(payoutV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/payouts/$ID/hold \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"reason\": \"reason\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "payouts release",
        "example": "straddle payouts release \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --reason reason"
      },
      "csharp": {
        "method": "Payouts.Release",
        "example": "PayoutReleaseParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    Reason = \"reason\",\n};\n\nvar payoutV1 = await client.Payouts.Release(parameters);\n\nConsole.WriteLine(payoutV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/payouts/$ID/release \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"reason\": \"reason\"\n        }'"
      }
    }
  },
  {
    ...
    "description": "Cancel a payout to prevent it from being processed. The status of the payout must be `created`, `scheduled`, or `on_hold`.",
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "payouts cancel",
        "example": "straddle payouts cancel \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e \\\n  --reason reason"
      },
      "csharp": {
        "method": "Payouts.Cancel",
        "example": "PayoutCancelParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\",\n    Reason = \"reason\",\n};\n\nvar payoutV1 = await client.Payouts.Cancel(parameters);\n\nConsole.WriteLine(payoutV1);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/payouts/$ID/cancel \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\" \\\n    -d '{\n          \"reason\": \"reason\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "cli": {
        "method": "payouts unmask",
        "example": "straddle payouts unmask \\\n  --api-key 'My API Key' \\\n  --id 182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e"
      },
      "csharp": {
        "method": "Payouts.Unmask",
        "example": "PayoutUnmaskParams parameters = new()\n{\n    ID = \"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e\"\n};\n\nvar response = await client.Payouts.Unmask(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/payouts/$ID/unmask \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "csharp": {
        ...
        "example": "ReportCreateTotalCustomersByStatusParams parameters = new();\n\nvar response = await client.Reports.CreateTotalCustomersByStatus(parameters);\n\nConsole.WriteLine(response);"
      },
      "http": {
        "example": "curl https://sandbox.straddle.com/v1/reports/total_customers_by_status \\\n    -X POST \\\n    -H \"Authorization: Bearer $STRADDLE_API_KEY\""
      }
    }
  }
];
