...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ data: { id: string; amount: number; config: { auto_hold?: boolean; auto_hold_message?: string; sandbox_outcome?: string; }; currency: string; description: string; device: { ip_address: string; }; external_id: string; funding_ids: string[]; paykey: string; payment_date: string; refund: boolean; status: string; status_details: object; status_history: { changed_at: string; message: string; reason: string; source: 'watchtower' | 'bank_decline' | 'customer_dispute' | 'user_action' | 'system'; status: string; code?: string; }[]; trace_ids: object; created_at?: string; customer_details?: object; effective_at?: string; metadata?: object; paykey_details?: object; payment_rail?: 'ach'; processed_at?: string; related_payments?: object; updated_at?: string; }; meta: { api_request_id: string; api_request_timestamp: string; }; response_type: 'object' | 'array' | 'error' | 'none'; }",
    markdown:
