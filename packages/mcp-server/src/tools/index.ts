...
import cancel_embed_linked_bank_accounts from './embed/linked-bank-accounts/cancel-embed-linked-bank-accounts';
...
import refresh_review_customers_review from './customers/review/refresh-review-customers-review';
...
import update_balance_paykeys from './paykeys/update-balance-paykeys';
import decision_paykeys_review from './paykeys/review/decision-paykeys-review';
import get_paykeys_review from './paykeys/review/get-paykeys-review';
import refresh_review_paykeys_review from './paykeys/review/refresh-review-paykeys-review';
...
addEndpoint(cancel_embed_linked_bank_accounts);
...
addEndpoint(refresh_review_customers_review);
...
addEndpoint(update_balance_paykeys);
addEndpoint(decision_paykeys_review);
addEndpoint(get_paykeys_review);
addEndpoint(refresh_review_paykeys_review);
