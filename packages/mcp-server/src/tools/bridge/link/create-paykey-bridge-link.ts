...
export const handler = async (client: Straddle, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.bridge.link.createPaykey(body)));
};
