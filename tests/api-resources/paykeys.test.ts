...
describe('resource paykeys', () => {
  test('retrieve', async () => {
    const responsePromise = client.paykeys.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e');
  ...
  test('retrieve: request options instead of params are passed correctly', async () => {
    ...
    await expect(
      client.paykeys.retrieve('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { path: '/_stainless_unknown_path' }),
