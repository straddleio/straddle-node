...
describe('resource review', () => {
  test('decision: only required params', async () => {
    const responsePromise = client.customers.review.decision('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', { status: 'verified' });
  ...
  test('get: request options and params are passed correctly', async () => {
    ...
    await expect(client.customers.review.get('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
    'Correlation-Id': 'Correlation-Id',
    'Request-Id': 'Request-Id',
    'Straddle-Account-Id': '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
  ...
  test('refreshReview: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.customers.review.refreshReview('182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e', {
    'Correlation-Id': 'Correlation-Id',
    'Idempotency-Key': 'xxxxxxxxxx',
    'Request-Id': 'Request-Id',
    'Straddle-Account-Id': '182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e',
